    ...
    let today = day + '/' + month + '/' + year;
        ...
        return (
          ...
          ¿Cómo ha ido el día?
              ...
              <form className= "flex">
                <label for="o1"><input type="radio" value=":)" id="o1" name="options" className="label" onChange={this.showMessages}/> :)</label>
                <label for="o2"><input type="radio" value=":(" id="o2" name="options" className="label" onChange={this.handleChange} /> :(</label>
          ...
          <Link to="/" style={{ textDecoration: 'none' }} className= "flex">
            ...
            <button type="button" name="button" className="cancelButton" onClick={this.pushCancelButton} >Cancelar</button>
          </Link>
          <Footer/>
        </div>
